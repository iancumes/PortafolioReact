    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Aqui se encuentran algunos de mis proyectos más destacados, donde
          he aplicado mis habilidades en cada uno de ellos.
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/iancumes"
          >
            Un vistazo a mi Github <ArrowRight size={16} />
          </a>
        </div>
      </div>
    </section>
